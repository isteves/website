...
I am certainly not the first person to be frustrated by encoding issues, though I am (maybe _too_) hopeful that I'll be one of the last. We live in the age of vacuum bots and 3D-printing, so what makes multi-language support so complicated? 
